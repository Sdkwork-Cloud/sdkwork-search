# sdkwork-routes-search-app-api

Domain: intelligence
Capability: routes-search-app-api
Package type: rust-route-crate
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-routes-search-app-api`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../../sdkwork-specs/`.
