...
Domain: intelligence
Capability: search-mobile
Package type: react-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/search-mobile-react`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
