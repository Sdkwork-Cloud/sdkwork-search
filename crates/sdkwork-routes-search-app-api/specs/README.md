...
This directory is the local SDKWork component contract for `sdkwork-routes-search-app-api`.

- Component root: `sdkwork-search/packages/native-rust/routes/app-api/sdkwork-routes-search-app-api`
