# sdkwork_search_storage_sqlx

Domain: drive
Capability: search-storage-sqlx
Package type: rust-crate
Status: standard

This README is the SDKWork module entrypoint for `sdkwork_search_storage_sqlx`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
