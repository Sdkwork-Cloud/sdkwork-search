...
Component-local specifications for SDKWork Search H5 application.

## Purpose

Contains the machine-readable component contract and local specification extensions for the H5 search application root.
