...
Domain: intelligence
Capability: search-h5
Package type: react-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/search-h5-react`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
