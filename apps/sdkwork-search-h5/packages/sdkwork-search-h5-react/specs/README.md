...
This directory is the local SDKWork component contract for `@sdkwork/search-mobile-react`.

- Component root: `sdkwork-search/packages/mobile-react/foundation/sdkwork-search-mobile-react`
