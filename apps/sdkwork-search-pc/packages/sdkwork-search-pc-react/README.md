...
Domain: intelligence
Capability: search-pc
Package type: react-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/search-pc-react`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
