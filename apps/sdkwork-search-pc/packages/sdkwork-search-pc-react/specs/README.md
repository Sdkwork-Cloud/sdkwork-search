...
This directory is the local SDKWork component contract for `@sdkwork/search-pc-react`.

- Component root: `sdkwork-search/packages/pc-react/foundation/sdkwork-search-pc-react`
